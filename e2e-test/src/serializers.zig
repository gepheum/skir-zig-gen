...
const PrimitiveType = base_serializer.PrimitiveType;
const ArrayDescriptor = base_serializer.ArrayDescriptor;
const StructField = base_serializer.StructField;
const EnumConstantVariant = base_serializer.EnumConstantVariant;
const EnumWrapperVariant = base_serializer.EnumWrapperVariant;
const EnumVariant = base_serializer.EnumVariant;
const StructDescriptor = base_serializer.StructDescriptor;
const EnumDescriptor = base_serializer.EnumDescriptor;
const TypeDescriptor = base_serializer.TypeDescriptor;
